...
function loadStatsPage(){
	...
	for(row_counter = 2; row_counter < table.rows.length; row_counter++){
		...
		var homeScore = table.rows[row_counter].cells[2].innerHTML;
		homeScore = parseInt(homeScore);
		var oppScore = table.rows[row_counter].cells[3].innerHTML;
		oppScore = parseInt(oppScore);

		if(homeScore > oppScore) { //home won
...
function loadPlayersPage(){
	...
	for(var i = 0; i < players.length; i++) {
			...
			anchor.onclick = function () {
				...
				//selector.innerHTML = players[this.index].name;
			};
...
function switchPlayers(index){
	...
	document.getElementById("player_img").alt = players[index].name;
	...
	document.getElementById("avg_p_yards").innerHTML = Math.round(parseInt(players[index].pass_yards) / parseInt(players[index].games_played));
	document.getElementById("avg_r_yards").innerHTML = Math.round(parseInt(players[index].rushing_yards) / parseInt(players[index].games_played));
	document.getElementById("avg_rec_yards").innerHTML = Math.round(parseInt(players[index].receiving_yards) / parseInt(players[index].games_played));
